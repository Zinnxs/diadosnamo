...
const cards = [
  {
    ...
    description: "Cada filme fica melhor com você! Nossos favoritos vão de La La Land a Devoradores de Estrela, sempre com muita pipoca.",
    color: "text-cyan-500",
    bg: "bg-cyan-50",
  },
  {
    ...
    description: "De jantares chiques a lanches de madrugada. Tudo é mais gostoso quando estamos juntos.",
  ...
  },
  {
    ...
    description: "Nossa vida tem a melhor playlist, uma mistura perfeita entre as eras da Taylor Swift e a vibe boa do Lagum.",
    color: "text-blue-500",
    bg: "bg-blue-50",
  },
];
